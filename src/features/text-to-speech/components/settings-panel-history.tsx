  ...
  return (
    <div className="flex h-full flex-col items-center justify-center gap-2 p-8">
      <div className="relative flex w-25 items-center justify-center">
        <div className="absolute left-0 -rotate-30 rounded-full p-3 bg-muted">
          <AudioLines className="size-4 text-muted-foreground" />
        </div>

        <div className="relative z-10 rounded-full bg-foreground p-3">
          <AudioWaveform className="size04 text-background" />
        </div>

        <div className="absolute right-0 rotate-30 rounded-full p-3 bg-muted">
      ...
      <p className="max-h-48 text-center text-xs text-muted-foreground">
